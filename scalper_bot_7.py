"""Dedicated BNB/USDT live WebSocket scalper (WBNB execution)."""
...
BOT, MARKET_SYMBOL, TRADE_SYMBOL = "scalper_bot_7", "BNBUSDT", "WBNB"
PATHS = ScalperPaths.for_bot(BOT)
LOGGER = logging.getLogger(BOT)
def main() -> None:
    settings = replace(Settings.from_environment(isolated_scalper_profile=BOT),
                       strategy_state_file=str(PATHS.trader_state))
